...
1. We're almost ready to use ``ansible-playbook`` to set up a GitHub Runner on your own server, but first we need to generate a token, as follows:
    ...
    If you now go to GitHub https://github.com/<your organization>/<your repository>/settings/actions, you should see a
    ...
    get an overview of previous GitHub actions by navigating to https://github.com/<your organization>/<your repository>/actions.
